...
class swashbuckler:
    ...
    def f_abilities(self):
		...
		drawText(' '+dam,font,windowSurface,0,0,TEXTCOLOR)
		drawText('(1): Daring Strike, Deals '+str(self.dexterity+self.strength)+' to '+str((self.dexterity+self.strength)*5)+' damage. Incresed by Dexterity and Strength.',font,windowSurface,100,0,TEXTCOLOR)
		drawText('Deals bonus damage to bleeding enemies.',font,windowSurface,100,30,TEXTCOLOR)
		drawText('(2): Puncture Deals '+str(self.dexterity+self.strength)+' to '+str((self.dexterity+self.strength)*2)+' damage. Incresed by Dexterity and Strength.'+dam,font,windowSurface,100,60,TEXTCOLOR)
		drawText('Causes the enemy to bleed.'+dam,font,windowSurface,100,90,TEXTCOLOR)
		drawText('(3): Shank Deals '+str(1)+' to '+str(self.dexterity*5)+' damage. Incresed by Dexterity.'+dam,font,windowSurface,100,90,TEXTCOLOR)
		drawText('Has a high crit chance and on critical hit caues the enemy to bleed.'+dam,font,windowSurface,100,120,TEXTCOLOR)
    ...
    def f_ability0(self):
    	...
    	if miss <= self.miss:
            ...
            drawText('You hit for '+self.damage,font,windowSurface,100,0,TEXTCOLOR)
    	else:
    		self.damage = damage
    ...
    def f_bleed(self):
    	if self.bleed:
    		...
    		drawText("Your enemy's wounds bleed for "+bleed_damage,font,windowSurface,100,90,TEXTCOLOR)
...
class warlock:
    def __init__(self,name):
        ...
        self.target = 'unknown'
        self.abilities = ['Power Siphon','Entropic Assault','blood armor']
        self.xp = 0
        self.lvl = 1
    def f_displayStats(self):
        print "Class: ", self.cls, "\nName: ", self.name,"\nLevel: ",self.lvl, "\nStamina: ", self.stamina, "\nWisdom: ", self.wisdom, "\nIntellect: ",self.intellect, "\nDexterity: ",self.dexterity, "\nStrength: ",self.strength, "\nMiss: ",self.miss,"\nCrit: ",self.crit
